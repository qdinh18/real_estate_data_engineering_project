...
def load_data_to_postgresql():
    # List of tuples containing CSV file paths and their corresponding target table names
    files_and_tables = [
        ('airflow_dag/data_stage/dim_tables/dim_broker.csv', 'dim_broker'),  # CSV file for dim_broker table
        ('airflow_dag/data_stage/dim_tables/dim_post.csv', 'dim_post'),  # CSV file for dim_post table
        ('airflow_dag/data_stage/dim_tables/dim_project.csv', 'dim_project'),  # CSV file for dim_project table
        ('airflow_dag/data_stage/fact_table/fact_all_apartment.csv','fact_all_apartment')  # CSV file for fact_all_apartment table
    ]
    ...
    try:
        ...
        print("All CSV files have been loaded successfully.")  # Indicate successful completion of data loading
        ...
        print("Error occurred while loading CSV files into PostgreSQL:", e)  # Print the error message
