...
def upload_csv_to_s3():
    ...
    file_paths = [
        'airflow_dag/data_stage/dim_tables/dim_broker.csv',
        'airflow_dag/data_stage/dim_tables/dim_post.csv',
        'airflow_dag/data_stage/dim_tables/dim_project.csv',
        'airflow_dag/data_stage/fact_table/fact_all_apartment.csv'
    ]
    ...
    for file, key in zip(file_paths, s3_keys):
        s3_hook.load_file(
